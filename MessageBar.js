...
class MessageBar extends Component {
  ...
  */
   _applyAlertStylesheet(alertType) {
      ...
      this.setState({backgroundColor: backgroundColor, strokeColor: strokeColor});
   }
  ...
  */
   _changeOffsetByPosition(position) {
      switch (position) {
         case 'top':
            this.setState({viewBottomOffset: null});
            break;
         case 'bottom':
            this.setState({viewTopOffset: null});
            break;
         default:
            this.setState({viewBottomOffset: null});
            break;
   ...
   render() {
      ...
      return (
         <Animated.View style={{
            ...
            <TouchableOpacity onPress={ this._alertTapped } style={styles.tappableContainer}>
               <View style={[styles.innerContainer, this.state.containerStyle]}>
                  {this.renderImage()}
